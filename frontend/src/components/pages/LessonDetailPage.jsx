              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-lg border border-gray-200 p-4">
                  ...
                  <div className="mt-3 space-y-2">
                    {Array.isArray(lesson.teachers) && lesson.teachers.length > 0 ? (
                ...
                <div className="rounded-lg border border-gray-200 p-4">
                  ...
                  <div className="mt-3 space-y-2 text-sm text-gray-700">
                    ...
                    <div>
                      ...
                      {Array.isArray(lesson.student_links) ? lesson.student_links.length : 0}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-4 overflow-x-auto">
                  {Array.isArray(lesson.student_links) && lesson.student_links.length > 0 ? (
                    <table className="min-w-full text-sm">
                      ...
                      <tbody>
                        {lesson.student_links.map((link) => {
                          const student = link?.student;
                          return (
                            <tr key={student?.id ?? `${lesson.id}-${Math.random()}`} className="border-b border-gray-100">
